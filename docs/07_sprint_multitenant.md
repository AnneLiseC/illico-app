...
- [ ] **`partenaire_taux` absent sur l'artisan (NOUVEAU, audit 01/06, à arbitrer vs doc 04).** Aucun taux de commission partenaire stocké sur la fiche artisan ; la commission vit sur `devis_artisans.commission_pourcentage`. À arbitrer : est-ce un manque ou un choix de modèle ? Normalemenr c'est un choix ça se fais depuis le devis.
