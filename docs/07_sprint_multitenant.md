...
- [ ] **Écrans de saisie des objectifs de CA** (gestion `objectifs_ca`) — **CADRÉ, prêt à coder** (audit lecture seule fait sur `1d3cc91`).
...
**Prochaine action** : **Écrans de saisie des objectifs de CA** — cadré et prêt à coder (voir Phase 4, audit lecture seule fait sur `1d3cc91`). Lot 100% applicatif (policy/colonnes/trigger déjà en base, aucun SQL). Puis **Phase 5 : L14a** (fix reconnexion, BLOQUANT pour le test).
