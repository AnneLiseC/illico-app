...
export default function LoginClient() {
  ...
  // Mot de passe oublié : lien de réinitialisation envoyé depuis NOTRE boîte d'envoi
  // (route /api/reset-password → Graph), plus de Supabase. Message générique
  // anti-énumération (la route ne révèle jamais si un compte existe).
  ...
  return (
    <div className="login-shell" style={{position:'fixed', inset:0, display:'grid', gridTemplateColumns:'1fr 1fr', background:'#fff', overflow:'auto', zIndex:9999}}>
      ...
      <div className="login-brand" style={{
        ...
        background:'linear-gradient(135deg, var(--brand-800) 0%, var(--brand-900) 60%, #312e81 100%)',
        ...
        <div style={{position:'absolute', bottom:-120, left:-60, width:280, height:280, borderRadius:'50%', background:'rgba(99,102,241,0.10)'}}/>
