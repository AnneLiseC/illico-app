...
// Email d'invitation Coordibat (envoyé par NOUS via la boîte d'envoi, plus par
...
export function buildInvitationEmail({ prenom, nom, actionLink, role }) {
  ...
  const intro = estAdmin
    ? "Vous êtes invité·e à rejoindre <strong>Coordibat</strong> en tant que franchisé·e. Créez votre accès pour configurer votre société et votre première agence."
    : "Vous êtes invité·e à rejoindre <strong>Coordibat</strong>. Créez votre accès pour rejoindre votre espace agent."
  const cta = estAdmin ? 'Créer mon accès' : 'Rejoindre mon espace'

  const subject = estAdmin
    ? 'Coordibat — Invitation franchisé·e'
    : 'Coordibat — Invitation à rejoindre votre espace'
  ...
  <div style="font-family:-apple-system,Segoe UI,Roboto,Arial,sans-serif;max-width:520px;margin:0 auto;color:#1f2937">
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px">
      ...
      <div style="font-size:16px;font-weight:800;color:#111827">Coordibat</div>
    </div>
