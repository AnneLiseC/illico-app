  ...
  return (
    <div className="page-enter" style={{display:'flex',flexDirection:'column',gap:18}}>
      ...
      <div className="tabs">
        ...
        <button className={`tab ${tab==='suivi'?'active':''}`} onClick={()=>setTab('suivi')}>
          <span style={{display:'inline-flex',gap:6,alignItems:'center'}}><I.Chart size={13}/> Suivi financier</span>
        </button>
        <button className={`tab ${tab==='facturation'?'active':''}`} onClick={()=>setTab('facturation')}>
          <span style={{display:'inline-flex',gap:6,alignItems:'center'}}><I.Doc size={13}/> Facturation agentes</span>
        </button>
      </div>
      ...
      {tab === 'suivi' && <SuiviFinView/>}
      {tab === 'facturation' && <FacturationAgentes/>}
    </div>
  );
}
