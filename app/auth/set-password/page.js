...
function Shell({ children }) {
  return (
    <div style={{position:'fixed', inset:0, display:'grid', placeItems:'center', padding:20, background:'linear-gradient(135deg, var(--brand-800) 0%, var(--brand-900) 60%, #0a3d38 100%)'}}>
