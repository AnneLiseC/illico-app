...
export default function CGU() {
  return (
    <LegalShell
      ...
      maj={MAJ_DATE}
      autreLien={<Link href="/confidentialite" style={{ color: '#00578e' }}>Politique de confidentialité</Link>}
    >
